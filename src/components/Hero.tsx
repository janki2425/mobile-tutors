        ...
        <div className="relative w-full h-[620px]">
          <div className='absolute w-full max-w-[1360px] top-1/2 -translate-y-1/2 left-0 gap-4 md:gap-6 flex flex-col items-center md:items-start z-10'>
            ...
            <div className="flex flex-col md:flex-row w-full px-4 md:px-8 lg:px-16 items-center justify-center md:justify-start gap-4 md:gap-6 z-10">
              <Button 
              variant="default" 
              className='w-full md:w-auto bg-gold text-black P-16 md:text-base rounded-[16px] px-[24px] py-[12px] cursor-pointer'
              onClick={handleEnrollNow}
              >
                ENROLL NOW
              </Button>
              <Button variant="default" className='w-full md:w-auto bg-white text-black rounded-[16px] px-[24px] py-[12px] cursor-pointer'>
                <Image src="/footer-icon/star.svg" alt="star" width={23} height={22} />
                <p className='text-black P-16 md:text-base font-[500]'>Trustpilot</p>
              </Button>
            </div>
          </div>
          <div className="absolute bottom-[60px] left-[60px] flex w-full items-center justify-center md:justify-start gap-[24px] z-10">
