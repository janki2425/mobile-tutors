  ...
  return (
    <div className='w-full max-w-[1360px] mx-auto my-[80px] px-2 md:px-4 xxl:px-0'>
        <div className='w-full flex flex-col gap-[40px]'>
            <h3 className='text-center max-w-[800px] xl:text-start mx-auto xl:mx-0 px-4 xl:px-0 font-[500] text-[24px] md:text-[32px] lg:H3-48-120'>
            ...
            <div className='w-full max-w-[1142px] mx-auto flex flex-wrap gap-[72px] justify-center'>
                ...
                <div className='max-w-[231px] flex flex-col gap-[16px] bg-[#F5F5F5] rounded-[24px] p-[24px] items-start'>
                    <h2 className='H-74 font-[500]'>3K+</h2>
                    <div className='flex flex-col gap-[8px]'>
                        <h6 className='H6-20 font-[600]'>Students</h6>
                        <p className='P-16 font-[500]'>Lorem ipsum dolor sit amet conse tel.</p>
                    </div>
                </div>
                <div className='max-w-[231px] flex flex-col gap-[16px] bg-navy-blue text-white rounded-[24px] p-[24px] items-start'>
