...
const Contact = () => {
  return (
    <div className='max-w-[1360px] px-4 mx-auto my-8 sm:my-12 md:my-16 lg:my-[60px]'>
      <div className='flex flex-col lg:flex-row items-center lg:items-end'>
        ...
        {/* Form Section - Adaptive padding and border radius */}
        <div className='flex flex-col gap-4 sm:gap-5 md:gap-6 lg:gap-[24px] p-6 sm:p-8 md:p-10 lg:p-[40px] w-full lg:max-w-[600px] bg-gold 
          ...
          <div className='flex flex-col gap-3 sm:gap-4 md:gap-5 lg:gap-[24px] max-w-full lg:max-w-[520px]'>
            <h3 className='text-2xl sm:text-3xl md:text-4xl lg:text-[48px] font-[500] leading-tight'>
              Contact us to get tailored advice
            </h3>
            <p className='text-sm sm:text-base lg:text-[16px] font-[500]'>
              Get personalised help and all the information you need. Learn how MyEdSpace can help your child!
            </p>
          </div>
          <div className='w-full'>
            <form className='flex flex-col gap-3 sm:gap-4 lg:gap-[16px] w-full'>
              <input
                type='text'
                className='w-full bg-transparent border border-black rounded-[12px] lg:rounded-[16px] text-sm lg:text-[14px] p-2 lg:p-3 text-black placeholder:text-black/70'
              ...
              <Button
                variant='default'
                className='bg-black text-white rounded-[12px] lg:rounded-[16px] text-sm lg:text-[14px] py-2 lg:py-3 mt-2'
              >
                SUBMIT
              </Button>
            </form>
