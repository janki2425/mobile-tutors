...
const Benefits = () => {
  return (
    <div className="w-full max-w-[1440px] bg-[#F5F5F5] my-[80px] rounded-[60px] mx-auto">
      <div className="w-full max-w-[1360px] mx-auto py-[20px] lg:py-[80px] px-2 md:px-4 xxl:px-0 transition-all duration-300">
          ...
          {benefitList.map((benefit) => {
            ...
            return (
              <div
                ...
                } gap-[12px] lg:gap-[60px] items-center p-2 lg:p-0 rounded-[24px] transition-all duration-300`}
              >
                {/* Image Section */}
                <div className="relative w-full lg:w-1/2">
                  ...
                  <Image
                    ...
                    width={48}
                    height={48}
                    className={`absolute top-[20px] md:top-[40px]  ${isEven ? 'right-[20px] md:right-[40px]' : 'left-[20px] md:left-[40px]'} w-[30px] h-[30px] md:w-[48px] md:h-[48px]`}
                  />
                </div>
