...
const Courses = () => {
  return (
    <div className='w-full max-w-[1360px] mx-auto'>
      <div className='grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-[20px] md:gap-[40px] xl:gap-[60px] justify-items-center rounded-[24px] transition-all duration-300'>
            <div className='w-full max-w-[250px] md:max-w-[280px] lg:max-w-[387px] cursor-pointer'>
              <Image src="/our-course/course-img-1.jpg" alt="course" width={387} height={300} className="rounded-t-[24px] w-full h-[180px] md:h-[220px] lg:h-[300px] object-cover transition-all duration-300" />
            ...
            <div className='w-full max-w-[250px] md:max-w-[280px] lg:max-w-[387px] cursor-pointer'>
                <Image src="/our-course/course-img-2.jpg" alt="course" width={387} height={300} className='rounded-t-[24px] h-[180px] md:h-[220px] lg:h-[300px] object-cover transition-all duration-300'/>
            ...
            <div className='w-full max-w-[250px] md:max-w-[280px] lg:max-w-[387px] cursor-pointer'>
                <Image src="/our-course/course-img-1.jpg" alt="course" width={387} height={300} className='rounded-t-[24px] h-[180px] md:h-[220px] lg:h-[300px] object-cover transition-all duration-300'/>
