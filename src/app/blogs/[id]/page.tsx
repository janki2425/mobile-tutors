        ...
        <div className='w-full max-w-[1360px] mx-auto py-[60px]'>
           <div className='w-full flex flex-col gap-[40px]'>
                <div className='flex flex-col gap-[16px]'>
                    ...
                    <div>
                        <h2 className='H-24 md:H4-40 lg:H2-56-120 font-[700] text-center md:text-left'>Personalised Assessment</h2>
                    </div>
                </div>
                <div className='flex flex-col justify-center items-center gap-[40px]'>
                    <div className='w-full h-[300px] md:h-[400px] lg:h-[500px]'>
                        <Image src="/blogs/blogs-img.jpg" alt='blogs' width={660} height={500} className='rounded-[24px] w-full h-full object-cover aspect-[2.5/1]'/>
                    </div>
